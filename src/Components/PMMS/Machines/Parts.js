...
export default function MachineParts({ partsObj }) {
        ...
        >
            ...
            <form autoComplete="off">
                <div className="offcanvas-header d-flex justify-content-between align-items-center mb-5">
                    <h5 id="offcanvasRightLabel" className="mb-0">Machine Spare Parts</h5>
                ...
                <div class="offcanvas-body" style={{ marginTop: "-2.5rem", maxHeight: "calc(100vh - 4rem)", overflowY: "auto" }}>
                    <button
                        className="btn btn-primary mb-2 d-flex ms-auto btn-sm sticky-top"
                        type="button"
    ...
    >
      ...
      >
        <PlusOutlined />
                            ...
                            <p className="text-muted text-center">No machine parts available.</p>
                        )}
                </div>
            </form>
                    ...
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Add Machine Part</h5>
