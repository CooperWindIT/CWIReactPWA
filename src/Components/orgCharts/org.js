...
const EmpNode = ({ data }) => {
  ...
  const isSpecialCard = specialCardRoles.includes(data.role);
  ...
  const getRoleStyle = () => {
    switch (data.role) {
      ...
      case "Assistant VP":
        return {
          border: "3px solid #6b14a5",
          image: "https://randomuser.me/api/portraits/men/45.jpg",
        };
      default:
        return {
          border: "3px solid #69a1d1",
          image: "https://randomuser.me/api/portraits/men/12.jpg",
        };
    }
  };
    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Name */}
          <div className="fw-bold fs-6">{data.label}</div>
    ...
    >
      <Popover content={popoverContent(data)} placement="bottom">
        ...
        >
          ...
          <div className="mt-3 fw-semibold text-dark text-truncate">
            {data.label}
          </div>
