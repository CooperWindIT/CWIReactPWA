...
export default function AssetlessMyTickets() {
    ...
    const fetchTicketsData = async () => {
        try {
            ...
            const response = await fetchWithAuth(
                `ServiceNow/MyGeneralTickets?OrgId=${sessionUserData?.OrgId}&UserId=${sessionUserData?.Id}`,
                {
                    method: "GET",
                    headers: {
