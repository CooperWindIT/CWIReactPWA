...
export default function ResolveTicket({ ticObj }) {
    const [resolveSubmitLoading, setResolveSubmitLoading] = useState(false);
    ...
    const handleResolveSubmit = async (e) => {
        ...
        const payload = {
            ...
            JsonData: {
                ...
                ResolvedDate: resolveForm.ResolutionDate,
            },
        };

        try {
            setResolveSubmitLoading(true);
                ...
                <div className="offcanvas-header border-bottom d-flex align-items-center">
                    ...
                    <div className="ms-auto d-flex align-items-center gap-2">
                        ...
                        <button
                            ...
                            type="submit"
                            disabled={resolveSubmitLoading}
                        >
                            {resolveSubmitLoading ? (
                                <>
                ...
                >
                    ...
                    <div className="card border-0 shadow-sm">
                        ...
                        <h6 className="mb-0 fw-bold ms-3 mt-3">
                            <i className="fa-solid fa-square-check text-primary me-2"></i>
                            Resolution Details
                        </h6>
