...
import { ArrowsAltOutlined, SearchOutlined, ShrinkOutlined } from '@ant-design/icons';
      ...
      <div style={{ width: 250 }}>
        ...
        <div className={styles.searchOptions}>
          <ToolButton
            ...
            className={styles.searchMiniTool}
...
//             // type="button"
//             active={searchCaseSensitive}
//             // className={[styles.searchToggle, searchCaseSensitive ? styles.searchToggleActive : ''].join(' ')}
//             onClick={() => onSearchCaseSensitiveChange(!searchCaseSensitive)}
//             title="Match case"
//           >
//             Aa
...
//           <button
//             type="button"
//             className={[styles.searchToggle, searchWholeWord ? styles.searchToggleActive : ''].join(' ')}
//             onClick={() => onSearchWholeWordChange(!searchWholeWord)}
...
//                   <ToolButton
//                     active={searchActive}
//                     className={[styles.actionButton, searchOpen || searchQuery ? styles.searchButtonActive : ''].join(' ')}
//                     onClick={() => setSearchActive(prev => !prev)}
//                   >
//                     <SearchOutlined />
//                   </ToolButton>
