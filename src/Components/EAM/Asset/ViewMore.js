...
export default function AssetViewMore() {
    ...
    const fetchAllData = async () => {
        ...
        try {
            ...
            const [machineJson, partsJson] = await Promise.all([machineRes.json(), partsRes.json()]);
        ...
        const fetchAlertsByMCNId = async () => {
            ...
            try {
                const response = await fetchWithAuth(`Public/AlertsByMonth?OrgId=${orgId}&ModuleId=${moduleId}&TableId=${machineId}&month=0&year=0`, {
                    method: "GET",
                    headers: { "Content-Type": "application/json" },
                });
                ...
                setAlertsData(normalizedAlerts);
    ...
    const formatDate = (dateString) => {
        ...
        // ✅ If null/undefined/empty return blank or "-"
    ...
    const handlePickup = async (item) => {
        ...
        try {
            const formPayload = {
                ...
                UserId: sessionUserData?.Id,
                JsonData: {
                    Logs: `System Engineer ${pickedBy} picked up asset ${ticketDetails?.MachineName} for off-site repairon ${pickupDate}.`,
                    TicketCode: ticketDetails?.TicketCode,
                    MachineId: ticketDetails?.MachineId
                }
            }
    ...
    const handleReturned = async () => {
        ...
        try {
            const formPayload = {
                ...
                UserId: sessionUserData?.Id,
                JsonData: {
                    Logs: `Asset ${ticketDetails?.MachineName} repaired and returned by ${returnedBy} on ${returnDate}; handed over to associate ${handedTo}.`,
                    TicketCode: ticketDetails?.TicketCode,
                    MachineId: ticketDetails?.MachineId
                }
            }
                            ...
                            >
                                <div className="card mt-4">
                                    <div className="card-body px-2 px-sm-3">
                                        <h5 className="text-dark fw-bold mb-3">Asset Details</h5>
                                                            ...
                                                            <div className="row g-3 mb-3 mt-8">
                                                                ...
                                                                <div className="mt-3">
                                                                    ...
                                                                    <textarea
                                                                        ...
                                                                        value={
                                                                            pickedBy && !returnedBy
                                                                                ? `System Engineer ${pickedBy} picked up asset ${ticketDetails?.MachineName} for off-site repairon ${pickupDate}.`
                                                                                : returnedBy
                                                                                    ? `Asset ${ticketDetails?.MachineName} repaired and returned by ${returnedBy} from ${returnedOrg} on ${returnDate}; handed over to associate ${handedTo}.`
                                                                                    : ""
                                                                        }
