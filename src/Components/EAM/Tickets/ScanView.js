...
import { BASE_IMAGE_API } from "../../Config/Config";
...
export default function TicketScanview() {
    ...
    useEffect(() => {
        if (machineData?.ImageUrls) {
            ...
            const fullUrls = filenames.map((name) => `${BASE_IMAGE_API}${name}`);
            setImages(fullUrls);
        }
    }, [machineData]);
    ...
    //         {/* Image */}
    //         <img
    //             src={`${BASE_IMAGE_API}${ticketDetails?.ImageUrl}`}
    //             alt="ticket"
                                        ...
                                        >
                                            {[
                                                ...
                                                },
                                                {
                                                    icon: "bi bi-bell",
                                                    label: "Next Due",
                                                    value: formatToDDMMYYYY(machineData?.UpcomingMaintenanceDate),
                                                },
                                                {
                                                ...
                                                machinePartsData.map((part, i) => (
                                                    <div className="col-12 px-2" key={i}>
                                                        ...
                                                        >
                                                            ...
                                                            <img
                                                                src={`${BASE_IMAGE_API}${part.ImageUrl}`}
                                                                alt={part.PartName}
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#imageModal"
                                                                data-img={`${BASE_IMAGE_API}${part.ImageUrl}`}
                                                                style={{
                                                                    width: "100px",
                                                                    height: "100px",
                                                                    objectFit: "cover",
                                    ...
                                    <div className={`list-group d-block d-md-none ${viewTicketShow ? 'd-none' : 'd-block'}`}>
                                        {mcnTicketsLoading ? (
                                            ...
                                            currentRecords.map((item, index) => {
                                                ...
                                                const imgSrc = `${BASE_IMAGE_API}${item.ImageUrl}` || ""; // fallback
                                                    ...
                                                    <div className="card shadow-sm border-0 p-3 rounded-3">
                                                        ...
                                                        <div className="d-flex flex-wrap align-items-start gap-3">
                                                            ...
                                                            {ticketUploadFiles?.map((item, index) => {
                                                                const fileUrl = `${BASE_IMAGE_API}${item.Col1}`;
                                                                                                        ...
                                                                                                        ticketDetails.ImageUrl.split(",").map((url, index) => (
                                                                                                            ...
                                                                                                            >
                                                                                                                <img
                                                                                                                    ...
                                                                                                                    onClick={() => setPreviewImage(`${BASE_IMAGE_API}${url.trim()}`)}
                                                                                                                    data-bs-toggle="modal"
