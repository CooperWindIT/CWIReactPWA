...
export default function TicketViewCommentsModal({ ticObj, onClose }) {
    ...
    {ticketComments?.map((comment, indx) => {
        ...
        return (
            ...
            <style>
                {`
                /* Container background - WhatsApp typically uses a light beige/grey */
                    .comments-chat {
                    ...
                    /* Sent Message (Light Green - Right side) */
                    .message-bubble.sent {
                        background: #dcf8c6;
                    ...
                    /* Optional: Add the little triangle tail */
...
TicketViewCommentsModal.propTypes = {
