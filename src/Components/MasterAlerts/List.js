...
export default function EAMAlertsList() {
    ...
    const fetchAlerts = async (page = 1, force = false) => {
        ...
        const payload = {
            ServiceName: "GetMachineAlertsByFilters",
            PageNumber: page,
        ...
        try {
            const response = await fetchWithAuth(`PMMS/GetMachineAlertsByFilters`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    return (
        <Base1>
            <div id="kt_app_toolbar" className="app-toolbar py-3 py-lg-6">
                <div id="kt_app_toolbar_container" className="app-container container-xxl d-flex flex-stack">
                    <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <h1 className="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Alerts List</h1>
                        <ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li className="breadcrumb-item text-muted">Alerts</li>
                        </ul>
                    </div>
                                            ...
                                            .map((item, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td
                                                        ...
                                                        onClick={() => handleDeleteAlertType(item)}
                                                    >
            ...
            <AddAlert machineId={0} />
            {/* <CloseAlert alertObj={closeData} /> */}
