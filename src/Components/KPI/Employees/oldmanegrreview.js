...
export default function ManagerReviewCycle() {
                ...
                <div id="kt_app_content" className="app-content flex-column-fluid" style={{ marginTop: "-30px" }}>
                    <div id="kt_app_content_container" className="app-container container-xxl py-5">
                        <div className="d-flex justify-content-between align-items-center flex-wrap mb-4">
                            <div>
                                <span className="review-header-badge mb-2 fw-bold d-inline-flex align-items-center">
                                    <i className="bi bi-clipboard2-check-fill me-2 text-primary"></i>
                            ...
                            {employeeName && (
                                <div className="text-end">
                                    ...
                                    <div className="employee-review-pill fs-3">
                        ...
                        <div className="review-header mb-5 p-1 position-relative overflow-hidden">
                            ...
                            <div className="d-flex justify-content-between align-items-center position-relative z-1">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h4 className="text-white fw-extrabold mb-1 d-flex align-items-center tracking-tight">
                            ...
                            {loading ? (
                                ...
                                <>
                                        ...
                                        <table className="table table-borderless align-middle mb-0">
                                            <thead>
                                                <tr className="text-nowrap">
                                                    <th style={{ minWidth: 260, whiteSpace: "nowrap" }} className="ps-4">KPI Metric & Objectives</th>
                                                    ...
                                                    <th style={{ width: 130, whiteSpace: "nowrap" }}>Manager Score</th>
                                                    <th style={{ minWidth: 220, whiteSpace: "nowrap" }}>Manager Remarks</th>
                                                    <th className="text-center pe-4" style={{ width: 140, whiteSpace: "nowrap" }}>Calculated</th>
                                                    <th className="text-center" style={{ width: 140, whiteSpace: "nowrap" }}>Weighted</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                        ...
                                                        <tr key={item.Id ?? index} className="review-row-card">
                                                            <td className="ps-4 py-4">
                                                                <div className="d-flex align-items-center mb-1">
                                                                    <div className="fw-bold text-slate-800 fs-6">
                                                                        {item.KPIName}
                                                                    </div>
                                                            ...
                                                            <td>
                                                                <div className="premium-input-wrapper">
                                                                    <Input
                                                                        ...
                                                                        value={item.Score1 ?? ""}
                                                                        placeholder="0"
                                                                        disabled={sessionUserData?.RoleId === 5}
                                                            ...
                                                            <td>
                                                                <div className="premium-input-wrapper">
                                                                    <Input
                                                                        ...
                                                                        value={item.Score2 ?? ""}
                                                                        placeholder="0"
                                                                        disabled={sessionUserData?.RoleId === 3 || item.Status === "DRAFT" || !item.Score1}
                                                            ...
                                                            <td>
                                                                <Input.TextArea
                                                                    ...
                                                                    autoSize={{ minRows: 2, maxRows: 3 }}
                                                                    disabled={sessionUserData?.RoleId === 3 || item.Status === "DRAFT" || !item.Remarks1}
                                                ...
                                                <tr className="table-primary border-top border-3">
                                                    <td colSpan={8} className="text-end fw-bold fs-4 py-4 pe-4">
                                    ...
                                    <div className="d-flex justify-content-end mt-5 gap-3 border-top pt-4">
                                        ...
                                        // disabled={loading || reviewStatus !== "UNDER_REVIEW" || reviewStatus !== "EVALUATED"}
                                        >
                                            {loading ? (
                                                <>
                                                ...
                                                <>
                                                    <i className="bi bi-floppy-fill me-2 text-white"></i>
                                                    Save as Draft
                                                </>
                                            )}
                                        </button>
                                        <button
                                            className="btn btn-success px-5 py-2.5 shadow-sm fw-bold"
                                            onClick={handleSubmitReview}
                                        // disabled={loading || reviewStatus === "SUBMITTED"}
                                        >
                                            {loading ? (
                                                <>
                                                    <span className="spinner-border spinner-border-sm me-2"></span>
